...
export function HomePage({ data, hasDraft, onEnter, onCreate, onTemplate }: {
  ...
  return <div className="home-page">
    <header className="home-nav"><a className="craft-brand" href="#/" aria-label="CraftCV 首页"><span className="brand-symbol"><LucideIcon name="FileText" size={21} /></span>CraftCV<span className="brand-caption">简历工坊</span></a><nav aria-label="主导航"><a href="#templates">简历模板</a><a href="#workflow">使用指南</a><a className="github-link" href="https://github.com/isbutch/resume-craft" target="_blank" rel="noreferrer"><LucideIcon name="Github" size={15} />GitHub</a><button className="craft-button primary small" onClick={onEnter}>进入编辑器 <LucideIcon name="ArrowUpRight" size={16} /></button></nav></header>
    <main>
    ...
    </main><footer className="home-footer"><span>CraftCV · 简历工坊</span><span>认真记录每一段成长。</span><div className="home-footer-links"><a href="#workflow">使用指南 <LucideIcon name="ArrowUpRight" size={13} /></a><a href="https://github.com/isbutch/resume-craft" target="_blank" rel="noreferrer"><LucideIcon name="Github" size={13} />开源项目</a></div></footer>
  </div>;
}
