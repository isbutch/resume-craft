import { ArrowDown, ArrowRight, ArrowUp, ArrowUpRight, Award, Briefcase, Calendar, Check, CheckCircle2, ChevronDown, ChevronLeft, ChevronRight, Circle, Code, Coffee, Download, Ellipsis, ExternalLink, Eye, FileCheck, FilePlus2, FileText, Github, GraduationCap, HardDrive, Heart, HelpCircle, Info, Layers, Layout, Loader2, Mail, MapPin, Maximize2, Minus, MousePointer, Palette, PanelsTopLeft, PenLine, Pencil, Phone, Plus, QrCode, Redo2, RotateCcw, ShieldCheck, Sliders, Sparkles, Tag, Trash2, Undo2, Upload, User, Wrench, X, XCircle, type LucideIcon as IconType } from 'lucide-react';
